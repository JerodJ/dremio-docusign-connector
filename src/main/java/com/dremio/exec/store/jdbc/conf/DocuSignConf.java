...
@SourceType(value = "DocuSignARP", label = "DocuSign",uiConfig = "docusign-layout.json")
public class DocuSignConf extends AbstractArpConf<DocuSignConf> {
  private static final String ARP_FILENAME = "arp/implementation/docusign-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.docusign.DocuSignDriver";
